 ...
 * ClassManager, EnchantmentManager) extiende esta clase fijando su
...
public class ContentManager<T extends RPGContent> implements Reloadable {
    ...
    protected ContentManager(RPGRoll plugin, YamlLoader yamlLoader, String folder, String label,
