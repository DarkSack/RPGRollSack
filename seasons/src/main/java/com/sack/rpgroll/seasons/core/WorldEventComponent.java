...
/** Mismo patrón "tipo + params" que el resto del proyecto (EffectComponent, SpellComponent...). */
public record WorldEventComponent(WorldEventComponentType type, Map<String, String> params) {
