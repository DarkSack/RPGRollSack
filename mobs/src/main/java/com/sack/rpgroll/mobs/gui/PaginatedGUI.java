...
/**
 * Base para GUIs paginadas: reserva la última fila para navegación y
 * expone un grid de contenido en las filas restantes. Copia del mismo
 * patrón usado en RPGRoll-Items — no se comparte entre addons.
 */
