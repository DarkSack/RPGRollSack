...
- 📚 **Ejemplo de referencia "todos los campos" en cada addon** — cada uno de los addons con contenido YAML incluye un archivo `_reference_full.yml` (o equivalente) que documenta absolutamente todas las opciones disponibles para su tipo de contenido principal, espejado en la web de documentación. El guion bajo hace que **no se cargue**: es documentación, no contenido de juego (quítaselo a una copia para probarlo)
