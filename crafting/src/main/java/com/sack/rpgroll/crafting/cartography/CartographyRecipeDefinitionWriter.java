...
public class CartographyRecipeDefinitionWriter {

    private final File folder;

    public CartographyRecipeDefinitionWriter(File dataFolder) {
        this.folder = new File(dataFolder, "cartography-recipes");
    }
    ...
    public void save(CartographyRecipeDefinition recipe) {
        ...
        writeIngredient(config, "map", recipe.mapIngredient());
        writeIngredient(config, "item", recipe.itemIngredient());
        ...
        try {
            ...
            throw new RuntimeException("No se pudo guardar la receta de cartografía " + recipe.id(), e);
        }
    }
