...
public class GrindstoneRecipeDefinitionWriter {

    private final File folder;

    public GrindstoneRecipeDefinitionWriter(File dataFolder) {
        this.folder = new File(dataFolder, "grindstone-recipes");
    }
    ...
    public void save(GrindstoneRecipeDefinition recipe) {
        ...
        writeIngredient(config, "upper", recipe.upperIngredient());
        writeIngredient(config, "lower", recipe.lowerIngredient());
        ...
        try {
            ...
            throw new RuntimeException("No se pudo guardar la receta de amolar " + recipe.id(), e);
        }
    }
